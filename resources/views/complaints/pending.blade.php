    ...
    <table class='table table-bordered table-striped' id="pending-data-table">
        ...
        @foreach ($pending_complaints as $pending)
            <tr>
                ...
                <td>
                    <a href="{{url('response/attend', [$pending->complaint_id ,$actions['not_close']])}}" ><span class="glyphicon glyphicon-eye-open">open</span></a>
                ...
                <td><a href="{{url('complaints/response', $pending->complaint_id)}}"><span class='glyphicon glyphicon-edit'>view</span></a>
                    <span style="margin-left: 1px;"><a href="{{action('Complaints\ResponseController@attend', [$pending->complaint_id,$actions['close']])}}"><span class='fa fa-lock'>close</span></a></span>
                </td>
            </tr>
        @endforeach
        </tbody>
