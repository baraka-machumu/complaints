        ...
        <div class="col-md-6">
            ...
            @if($report_data[0]->p3!==null)
                <div class="form-group">
                    ...
                    <input type="text" class="form-control scheme" id="scheme" name="data[{{$report_data[0]->p3}}]" >
                    {{--<select class="form-control" id="lgFormGroupInput" name="select_scheme"  style="height: 35px; font-size: 14px" required>--}}
                        {{--<option selected="true" disabled="disabled">---Select Scheme--</option>--}}
                        {{--@foreach($schemes as $scheme)--}}
                            {{--<option value="{{$scheme['scheme_id']}}">{{$schemes['scheme_name']}}</option>--}}
                        {{--@endforeach--}}
                    {{--</select>--}}
